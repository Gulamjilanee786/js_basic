...
// console.log(10 + "3"); // "103" (number 10 is converted to string and concatenated with "3")
// console.log(12- "3"); // 9 (string "3" is converted to number and subtracted from 12)
// console.log(12- "a"); // NaN (string "a" cannot be converted to number, resulting in Not-a-Number)